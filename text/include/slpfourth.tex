\begin{tikzpicture}
    ...
    \node at (1.25*1.5, 1.75*1.5) (lopt) {};
    \node at (0.88*1.5,0.8*1.5) (x1) {};
    \node[red] at (0.4*1.5, 1.95*1.5) (loptdesc) {$\hat{x}_2$};
    \node at (-0.5*1.5, 0.75*1.5) (qoptdesc) {$x^*$};
    \node at (1.95*1.5, 0.35*1.5) (x1desc) {$x_2$};
    ...
    \draw[scale=1.5,thick, red, name path=lobj, domain=0.48:1.28] plot(\x, {-0.625*\x + 1.35})
                                                                            {};
