...
\end{center}
\caption{Deviance as a function of density in the objective function.}
\label{fig:sparsobj}
\end{figure}

We can see that the density in the diagonal elements of $H$ has
close to zero influence on the deviance.
While we see that the density of $b$ certainly has more influence,
the deviance actually never change more than around $4\%$.
