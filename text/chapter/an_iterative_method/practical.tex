...
Readers are encouraged to compare Figure \ref{fig:lp3} with Figure
...
\caption{A visual representation of the new QP problem and its linearized
         version.}
\label{fig:prac1}
\end{figure}
...
\[
    T_0 = -2.5 + x - y,
\]
which becomes our new objective function. Solving that
linear program, we end up with an optimal solution $\hat{x}_0 = (0,0)$.
