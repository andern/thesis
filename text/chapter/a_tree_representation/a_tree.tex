...
V =
\{
v_0$,$v_2$,$v_3$,$v_7$,$v_8$,$v_{10}$,$v_{12}$,$v_{15}$,$v_{16}$,$v_{28}$,
$v_{29}
\}
$
and an edge set
...
$\left\{{0,16}\right\}$,$\left\{{2,3}\right\}$,$\left\{{8,10}\right\}$,
$\left\{{8,12}\right\}$,$\left\{{16,28}\right\}$,
$\left\{{3,7}\right\}$,
$\left\{{12,15}\right\}$,$\left\{{28,29}\right\} \}
$
