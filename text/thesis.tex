...
%\begingroup
%\let\clearpage\relax
\input{chapter/a_qp_problem/main}
\input{chapter/an_iterative_method/main}
\input{chapter/a_tree_representation/main}
\input{chapter/implementation/main}
\input{chapter/computational_experiments/main}
%\endgroup
...
to a QP solver, and the aim was to improve the performance of this the methods
...
word---\emph{close} to a linear program.
...
solver, it \emph{did} reduce the number of calls to the QP solver by a
